...
def store_chosen_categories(s_query, chosen_categories, s_key = "")
...
def get_chosen_category_ids(chosen_categories)
  cat_ids = []
...
def match_search_query_to_categories(s_query, s_key = "")
