class Practice < ApplicationRecord
  ...
  accepts_nested_attributes_for :timelines, allow_destroy: true, reject_if: proc{ |attributes| attributes['time_interval'].blank? || attributes['milestone'].blank? || attributes['timeline'].blank?}
