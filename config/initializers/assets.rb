...
Rails.application.config.assets.precompile += %w( practice_editor_documentation.js practice_editor_contact.js practice_editor_timeline.js practice_editor_origin.js practice_editor_risk_mitigation.js practice_editor_complexity.js practice_editor_overview.js diffusion_history/home_map.js diffusion_history/practice_map.js diffusion_history/_map_utilities.js )
