...
namespace :importer do
  ...
  task import_answers: :environment do |_t, _args|
  ...
  task initial_featured: :environment do |_t, _args|
...
def financial_files
  ...
  question_fields.each do |key, _value|
...
def risk_mitigations
  ...
  question_fields.each do |key, _value|
    ...
    next unless @answers[q_index + 1].present?
