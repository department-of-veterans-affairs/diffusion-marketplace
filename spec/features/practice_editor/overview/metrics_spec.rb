...
describe 'Practice editor', type: :feature, js: true do
    before do
        ...
        @choose_image_text= 'Choose an image to represent this innovation. Use a high-quality .jpg, .jpeg, or .png files less than 32MB. PII/PHI Waivers are required for photos featuring Veterans. Form must be filled out with the ‘External to VA’ check box selected.'
    end
