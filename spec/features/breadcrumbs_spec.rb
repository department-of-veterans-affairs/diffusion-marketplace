...
describe 'Breadcrumbs', type: :feature do
  before do
    ...
    @user_practice = Practice.create!(name: 'The Best Practice Ever!', tagline: 'A public tagline', user: @user, initiating_facility: 'Test facility name', initiating_facility_type: 'other', tagline: 'Test tagline')
    @user_practice2 = Practice.create!(name: 'Another Best Practice', tagline: 'A public tagline', user: @user, initiating_facility: 'vc_0508V', tagline: 'Test tagline 2')
