...
describe 'Search', type: :feature do
  before do
    ...
    PracticeOriginFacility.create!(practice: @practice, facility_type: 0, facility_id: '640A0', va_facility: facility_14)
    ...
    PracticeOriginFacility.create!(practice: @practice2, facility_type: 0, facility_id: '687HA', va_facility: facility_13)
    ...
    PracticeOriginFacility.create!(practice: @practice3, facility_type: 0, facility_id: '402', va_facility: facility_1)
    ...
    PracticeOriginFacility.create!(practice: @practice5, facility_type: 0, facility_id: '402', va_facility: facility_1)
    ...
    PracticeOriginFacility.create!(practice: @practice7, facility_type: 0, facility_id: '539QD', va_facility: facility_7)
    PracticeOriginFacility.create!(practice: @practice7, facility_type: 0, facility_id: '538GC', va_facility: facility_8)
    ...
    PracticeOriginFacility.create!(practice: @practice8, facility_type: 0, facility_id: '541GB', va_facility: facility_9)
    ...
    PracticeOriginFacility.create!(practice: @practice11, facility_type: 0, facility_id: '541GH', va_facility: facility_10)
    ...
    PracticeOriginFacility.create!(practice: @practice12, facility_type: 0, facility_id: '623GB', va_facility: facility_12)
    ...
    PracticeOriginFacility.create!(practice: @practice13, facility_type: 0, facility_id: '528QK', va_facility: facility_2)
    ...
    PracticeOriginFacility.create!(practice: @practice14, facility_type: 0, facility_id: '561BY', va_facility: facility_3)
    ...
    dh_1 = DiffusionHistory.create!(practice_id: @practice.id, facility_id: '438GD', va_facility: facility_16)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_1.id, status: 'Completed')
    dh_2 = DiffusionHistory.create!(practice_id: @practice.id, facility_id: '561BZ', va_facility: facility_4)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_2.id, status: 'Completed')
    dh_3 = DiffusionHistory.create!(practice_id: @practice.id, facility_id: '520', va_facility: facility_11)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_3.id, status: 'Completed')
    dh_4 = DiffusionHistory.create!(practice_id: @practice3.id, facility_id: '438GD', va_facility: facility_16)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_4.id, status: 'Completed')
    dh_5 = DiffusionHistory.create!(practice_id: @practice3.id, facility_id: '649GA', va_facility: facility_15)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_5.id, status: 'Completed')
    dh_6 = DiffusionHistory.create!(practice_id: @practice6.id, facility_id: '544GG', va_facility: facility_6)
    DiffusionHistoryStatus.create!(diffusion_history_id: dh_6.id, status: 'Completed')
    dh_7 = DiffusionHistory.create!(practice_id: @practice10.id, facility_id: '528QH', va_facility: facility_5)
