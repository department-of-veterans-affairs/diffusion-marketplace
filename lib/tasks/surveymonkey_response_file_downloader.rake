...
namespace :surveymonkey do
  ...
  task :download_response_files => :environment do
    ...
    questions = [
      ...
      [3, 226730310, "Do you have survey results, verifiable testimonials, press releases, news articles regarding your practice that you would like to share?"],
      [3, 226730361, "Additional practice information 1"],
      [3, 226730732, "Additional practice information 2"],
      [3, 226731325, "Does your practice have a formal business case?"],
      [3, 226731349, "Does your practice have an implementation toolkit?"],
      [3, 227449385, "Does your practice have a pre-implementation checklist?*"],
      [3, 226731863, "Does your practice have peer-reviewed publications associated with it?"],
      [3, 226732296, "Additional publication upload 1"],
      [3, 226738172, "Do you have a diffusion timeline regarding the steps to implement your practice?"],
