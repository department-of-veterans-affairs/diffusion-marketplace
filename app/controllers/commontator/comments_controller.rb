    ...
    respond_to do |format|
      if params[:cancel].blank?
        if @comment.save
          ...
          user_practice.update(verified_implementer: true, team_member: false, other: false) if params[:user_practice_status] == 'verified_implementer'
          user_practice.update(verified_implementer: false, team_member: true, other: false) if params[:user_practice_status] == 'team_member'
          user_practice.update(verified_implementer: false, team_member: false, other: true) if params[:user_practice_status] == 'other'
          @comment.save
