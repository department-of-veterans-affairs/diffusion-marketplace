  ...
  def recommended_for_you
    ...
    if current_user.present?
      ...
      @pagy_favorite_practices, @paginated_favorite_practices = pagy_array(
          ...
          page_param: 'favorite',
          items: 3,
          link_extra: "data-remote='true' class='paginated-favorite-practices-page-#{params[:favorite].nil? ? 2 : params[:favorite].to_i + 1}-link dm-button--outline-secondary margin-bottom-10 x075-top width-15'"
      )
      ...
      @pagy_created_practices, @paginated_created_practices = pagy_array(
          ...
          page_param: 'created',
          items: 3,
          link_extra: "data-remote='true' class='paginated-created-practices-page-#{params[:created].nil? ? 2 : params[:created].to_i + 1}-link dm-button--outline-secondary margin-bottom-10 x075-top width-15'"
      )
