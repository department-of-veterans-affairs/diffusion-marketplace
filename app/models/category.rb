class Category < ApplicationRecord
  ...
  has_many :practices, through: :category_practices, source: :innovable, source_type: 'Practice'
  has_many :products, through: :category_practices, source: :innovable, source_type: 'Product'
