...
describe 'Search', type: :feature do
  ...
  before do
    ...
    CategoryPractice.create!(innovable: @practice, category: @cat_2, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice, category: @cat_5, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice3, category: @cat_1, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice3, category: @cat_2, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice4, category: @cat_2, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice4, category: @cat_3, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice5, category: @cat_1, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice5, category: @cat_3, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice6, category: @cat_1, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice7, category: @cat_4, created_at: Time.now)
    CategoryPractice.create!(innovable: @practice12, category: @cat_1, created_at: Time.now)
