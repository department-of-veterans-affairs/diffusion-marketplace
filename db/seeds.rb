...
unless Rails.env.production?
    ...
    User.create!(email: "A6test#{index}@agile6.com", password: 'Password123', password_confirmation: 'Password123', first_name: "A6test#{index}", last_name: "Test", job_title: "Developer #{index}", phone_number: '333-333-3333', visn: 21, bio: "I\'m number #{index}!", skip_va_validation: true, confirmed_at: Time.now).add_role(User::USER_ROLES[0].to_sym)
end
