...
describe 'Favorites', type: :feature do
  before do
    ...
    @practice1 = Practice.create!(name: 'A public practice', slug: 'a-public-practice', approved: true, published: true, tagline: 'Test tagline', featured: true, highlight: true, user: @user)
